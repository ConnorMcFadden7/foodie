...
public abstract class FadingActionBarHelperBase {
    ...
    private boolean mHeaderGradientEnabled = true;
    private int mListViewBackgroundColor;
    ...
    public final <T extends FadingActionBarHelperBase> T  headerGradientEnabled(boolean value) {
        mHeaderGradientEnabled = value;
        return (T)this;
    }

    public final <T extends FadingActionBarHelperBase> T  listViewBackgroundColor(int value) {
        mListViewBackgroundColor = value;
        return (T)this;
    }
    ...
    private View createListView(ListView listView) {
        ...
        if (mListViewBackgroundColor != 0) mListViewBackgroundView.setBackgroundColor(mListViewBackgroundColor);
